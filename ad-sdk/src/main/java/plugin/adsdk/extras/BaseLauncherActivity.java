...
//        setContentView(splash);
       ...
       /* ValidationHandler.validateOptions(BaseLauncherActivity.this, () -> {
    ...
    private void launchLocalCall() {
        ...
        new Handler().post(this::onApiSuccess);
    }
            ...
            public void onResponse(@NotNull Call<ListModel> call, @NotNull Response<ListModel> response) {
                if (response.body() != null && response.isSuccessful()) {
                    try {
                        ...
                        e.printStackTrace();
                        onApiFailed("Error: Could not parse response!");
                    }
                } else {
...
//        }
    ...
    private void showSnack(String message) {
        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), message, BaseTransientBottomBar.LENGTH_INDEFINITE)
                .setAction("Retry", v -> launchLocalCall());
        snackbar.setActionTextColor(Color.RED);
