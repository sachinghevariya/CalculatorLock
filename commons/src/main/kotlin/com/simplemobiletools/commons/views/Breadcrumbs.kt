...
class Breadcrumbs(context: Context, attrs: AttributeSet) : HorizontalScrollView(context, attrs) {
    ...
    init {
        ...
        setBackgroundColor(ContextCompat.getColor(context,R.color.default_background_color))
        itemsLayout = LinearLayout(context)
        itemsLayout.orientation = LinearLayout.HORIZONTAL
        itemsLayout.setBackgroundColor(ContextCompat.getColor(context,R.color.default_background_color))
...
//                    breadcrumbText.background.applyColorFilter(textColor)
                    ...
                    val medium = getDimension(R.dimen.small_margin).toInt()
