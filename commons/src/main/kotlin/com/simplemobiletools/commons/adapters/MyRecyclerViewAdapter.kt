...
abstract class MyRecyclerViewAdapter(val activity: BaseSimpleActivity, val recyclerView: MyRecyclerView, val itemClick: (Any,Int) -> Unit) :
...
//                    setOnLongClickListener { if (allowLongClick) viewLongClicked() else viewClicked(any); true }
        ...
        fun bindView(itemClick:View ,any: Any, allowSingleClick: Boolean, allowLongClick: Boolean, callback: (itemView: View, adapterPosition: Int) -> Unit): View {
            return itemClick.apply {
                callback(this, adapterPosition)
...
//                    setOnLongClickListener { if (allowLongClick) viewLongClicked() else viewClicked(any); true }
        ...
        fun viewClicked(any: Any) {
            if (actModeCallback.isSelectable) {
                ...
                itemClick.invoke(any,adapterPosition)
            }
            lastLongPressedItem = -1
        }
