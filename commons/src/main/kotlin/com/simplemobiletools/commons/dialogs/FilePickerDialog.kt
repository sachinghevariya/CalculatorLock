...
class FilePickerDialog(
    ...
    private fun updateItems(items: ArrayList<FileDirItem>) {
        ...
        val adapter = FilepickerItemsAdapter(activity, sortedItems, mDialogView.filepickerList) {it,pos->
    ...
    private fun setupFavorites() {
        FilepickerFavoritesAdapter(activity, activity.baseConfig.favorites.toMutableList(), mDialogView.filepickerFavoritesList) {it,pos->
