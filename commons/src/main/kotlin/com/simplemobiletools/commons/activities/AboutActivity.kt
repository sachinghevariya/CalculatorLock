...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchFAQActivity() {
        ...
        Intent(applicationContext, com.simplemobiletools.commons.activities.FAQActivity::class.java).apply {
    ...
    private fun onContributorsClick() {
        val intent = Intent(applicationContext, com.simplemobiletools.commons.activities.ContributorsActivity::class.java)
    ...
    private fun onLicenseClick() {
        Intent(applicationContext, com.simplemobiletools.commons.activities.LicenseActivity::class.java).apply {
            putExtra(APP_ICON_IDS, intent.getIntegerArrayListExtra(APP_ICON_IDS) ?: ArrayList<String>())
            putExtra(APP_LAUNCHER_NAME, intent.getStringExtra(APP_LAUNCHER_NAME) ?: "")
    ...
    private fun onVersionClick() {
        if (firstVersionClickTS == 0L) {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                ...
                com.simplemobiletools.commons.activities.AboutActivity.Companion.EASTER_EGG_TIME_LIMIT
            )
        }

        clicksSinceFirstClick++
        if (clicksSinceFirstClick >= com.simplemobiletools.commons.activities.AboutActivity.Companion.EASTER_EGG_REQUIRED_CLICKS) {
