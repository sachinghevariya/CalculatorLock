...
import calculator.lock.hide.photo.video.calculatorvault.safe.photovault.hideru.vault.ui.filemanager.FoldersActivity.Companion.APPLICATION_ID
...
fun Activity.sharePaths(paths: ArrayList<String>) {
    sharePathsIntent(paths, APPLICATION_ID)
}
...
fun Activity.openPath(path: String, forceChooser: Boolean, openAsType: Int = OPEN_AS_DEFAULT) {
    openPathIntent(path, forceChooser, APPLICATION_ID, getMimeType(openAsType))
}
...
fun Activity.setAs(path: String) {
    setAsIntent(path, APPLICATION_ID)
}
